      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">
              Your notes are protected with secure authentication and reliable
              cloud storage and with enterprice-grade security and encryption.
            </p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">
              Clean and intuitive interface that lets
               you focus on that matters most 
              Clean and intuitive interface that lets
               you focus on that matters most 
            </p>
