...
function NoteForm(){
 ...
 const  handleSubmit = async (e)=>{
    ...
    try{
        ...
        setError("Failed to creat note"+err.message)
    }finally{
        setLoading(false);
    }
 }
    ...
    <div className='bg-white rounded-lg shadow-md p-6 mb-8'>
        <div className='flex items-center mb-4'>
            ...
            text-gray-800'>Add a new Notes</h2>
        </div>
        ...
        )}
        {
            success && (
             ...
             text-green-700 p-2 rounded-md mb-4 text-sm'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                focus:ring-2 focus:ring-indogo-500 '
